  ...
  return (
    <motion.a
      ...
      whileTap={reduce ? undefined : { scale: 0.95 }}
       className="fab-book-direct fixed z-[70] bottom-5 left-5 sm:bottom-6 sm:left-6 block select-none focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#c4804a] rounded-full"
