    ...
    <>
      ...
      {phoneNumber && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="fixed right-4 bottom-16 z-[60] flex items-center gap-2 bg-green-500 text-white px-4 py-3 shadow-xl hover:bg-green-600 transition-all duration-300 rounded-lg"
          aria-label="WhatsApp"
        >
