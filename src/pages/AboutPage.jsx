  ...
  return (
    <div ref={pageRef}>
      ...
      <section className="relative bg-brand-action overflow-hidden min-h-[45vh] flex items-center justify-center">
        ...
        <div className="relative flex flex-col items-center justify-center text-center w-full pt-20 pb-16 md:pt-24 md:pb-20">
      ...
      {/* Banner */}
      <section className="about-banner relative bg-brand-action py-6 md:py-10 overflow-hidden">
