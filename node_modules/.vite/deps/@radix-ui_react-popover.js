...
import {
  useId
} from "./chunk-QL4VUH7E.js";
import {
  useSize
} from "./chunk-7KWKMPQ2.js";
import {
  DismissableLayer,
  Portal,
  useCallbackRef
} from "./chunk-UTDH3RUE.js";
import {
  Presence,
  Primitive,
  ...
  useLayoutEffect2
} from "./chunk-OGN7ESTM.js";
import {
  createSlot,
  useComposedRefs
} from "./chunk-6DT5MC2E.js";
import {
  require_react_dom
...
var Popover = (props) => {
  ...
  const [hasCustomAnchor, setHasCustomAnchor] = React15.useState(false);
  ...
  return (0, import_jsx_runtime4.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime4.jsx)(
    PopoverProvider,
    {
      ...
      hasCustomAnchor,
      onCustomAnchorAdd: React15.useCallback(() => setHasCustomAnchor(true), []),
      onCustomAnchorRemove: React15.useCallback(() => setHasCustomAnchor(false), []),
      modal,
      children
    }
  ) });
...
var PopoverAnchor = React15.forwardRef(
  (props, forwardedRef) => {
...
var PopoverTrigger = React15.forwardRef(
  (props, forwardedRef) => {
...
var PopoverContentModal = React15.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME2, props.__scopePopover);
    const contentRef = React15.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const isRightClickOutsideRef = React15.useRef(false);
    React15.useEffect(() => {
...
var PopoverContentNonModal = React15.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME2, props.__scopePopover);
...
var PopoverContentImpl = React15.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopover,
      trapFocus,
...
var PopoverClose = React15.forwardRef(
  (props, forwardedRef) => {
...
var PopoverArrow = React15.forwardRef(
  (props, forwardedRef) => {
